...
El *MasterStockTransformer* superó significativamente al modelo LSTM clásico. Al medir el Error Absoluto Medio (MAE), el modelo Transformer logró predecir el precio con un margen de error de tan solo \$2.81 dólares, frente a los \$3.21 dólares del LSTM. Asimismo, el RMSE del Transformer fue de \$4.01 frente a los \$4.40 del LSTM, con un R² sobresaliente de 0.9930. Esta reducción del error en casi 40 centavos por acción justifica contundentemente la superioridad de la arquitectura basada en atención para series de tiempo financieras de alta volatilidad. Adicionalmente, el análisis de los residuales mostró una distribución normal centrada en cero (ruido blanco), demostrando ausencia de sesgo predictivo.
...
Esta investigación empírica demuestra que el uso de mecanismos de Atención Cruzada (Cross-Attention) en arquitecturas Transformer mejora significativamente la predicción direccional de activos financieros individuales al integrarlos con el contexto macroeconómico. Al lograr un R² de 0.9930 y reducir el error absoluto a \$2.81 frente al baseline LSTM, el *MasterStockTransformer* evidencia que el comportamiento del mercado dicta, en gran medida, el destino de una acción individual. La visualización de los pesos de atención proporciona una herramienta robusta, precisa e interpretable para la gestión cuantitativa de riesgos e inversiones.
